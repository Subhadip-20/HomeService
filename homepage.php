...
<header>
    ...
    <nav class="navbar">
        ...
        <a style="--i:6;" href="#" id="loginButton"><b>Login</b></a>
...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>Carpenter</h3>
            <p>Our carpenters are involved in the designing, Measuring, marking up, cutting, shaping, fitting and finishing using different types of wood. They will work on sites, in clients homes, or in a workshop etc..</p>
            <a href="#" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>Electrician</h3>
            <p>Our electricians are a skilled professional who specializes in installing, maintaining, and repairing electrical systems in buildings and structures. They are responsible for ensuring the proper functioning of electrical wiring, fixtures, and equipment to provide electricity for various purposes.</p>
            <a href="#" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>Plumber</h3>
            <p>Our plumbers install and repair pipes and fixtures that carry water, gas, or other fluids in homes and businesses.</p>
            <a href="#" class="btn">read more</a>
        </div>
        ...
        <div class="box">
            ...
            <p>Our painters and decorators are the tradesman responsible for the painting and decorating of buildings. Their purpose of painting is to improve the appearance of a building and to protect it from damage by water, corrosion, insects and mould.</p>
            <a href="#" class="btn">read more</a>
        </div>
...
<div class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>category</h3>
            <a href="#">Women's Salon & Spa</a>
            <a href="#">Men's Salon & massage</a>
            <a href="#">Care Taker</a>
            <a href="#">Cook</a>
            <a href="#">Carpenter</a>
            <a href="#">Electrician</a>
            <a href="#">Plumber</a>
            <a href="#">Painter & Decorator</a>
            <a href="#">Cleaning & Pest Control</a>
            <a href="#">Mechanic</a>
        </div>
